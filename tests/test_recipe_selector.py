...
def test_explicit_recipe_field_wins_when_allowlisted():
    ...
    assert g._select_recipe({"directive_id": "x", "recipe": "module_from_exemplar"}) == "module_from_exemplar"
...
def test_recipe_files_exist_and_parse():
    ...
    for name in ("webapp_backend_fastapi", "webapp_frontend_react", "webapp_fullstack", "module_from_exemplar"):
