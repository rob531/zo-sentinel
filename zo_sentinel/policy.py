...
KEYS: Dict[str, Dict[str, Any]] = {
    ...
    "vuln.enabled":               {"type": "bool", "default": False,
                                   "env": "ZO_VULN_ENABLED",
                                   "doc": "vuln-intel surface kill-switch (off => INSUFFICIENT)"},
    "vuln.otx_enabled":           {"type": "bool", "default": False,
                                   "env": "ZO_VULN_OTX_ENABLED",
                                   "doc": "OTX threat-intel context layer kill-switch (off => disabled, no claims)"},
