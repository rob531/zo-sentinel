# deps: requests
"""Auto-emitted service _impl for services/auto_emitted_service.

Mirrors auto_emitted_service._impl so relative imports within services
work without modification during staged->active promotion.
"""
...
PerspectiveSnapshotBase = Base
PerspectiveSnapshotCreate = Base
