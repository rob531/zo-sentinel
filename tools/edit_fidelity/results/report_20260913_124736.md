# Edit-fidelity eval -- 20260913_124736
...
|---|---|---|---|---|---|---|---|---|---|
| anthropic_plain | 30 | 30 | 0 | 0.3058 | 0.0049 | 0.9382 | -0.500 | 0 | 0.5667 (17/30) |
| anthropic_preserve | 30 | 30 | 0 | 0.0632 | 0.0000 | 0.9257 | -0.357 | 0 | 0.7333 (22/30) |
...
|---|---|---|---|---|---|---|
| anthropic_plain | 17 | 0.0024 | -0.471 | 12 | 13 | 0.7027 |
| anthropic_preserve | 22 | 0.0009 | -0.227 | 18 | 8 | 0.2342 |

## Paired comparison: anthropic_preserve vs anthropic_plain (same tasks)

- n paired: 30
- fidelity_lev: preserve lower on 12, higher on 6, ties 12; sign-test p = 0.2379
- delta_cc: preserve lower on 0, higher on 0, ties 30; sign-test p = UNKNOWN
- pass@1: preserve 22 vs plain 17 (of 30)

### Power of this sample (two-sided sign test, alpha 0.05)

- non-tied fidelity pairs: 18 of 30
- power to detect a per-pair preference of 0.65 / 0.75 / 0.85 for the preservation arm: 0.1889 / 0.5187 / 0.8794
- smallest per-pair preference detectable at 80% power with this many non-tied pairs: 0.83
