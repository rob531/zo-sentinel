...
if __name__ == "__main__":
    ...
    with TestSession() as db:
        ...
        # ana-001: low risk
        for i, (axis, p_top, p_crit, p_dang, label) in enumerate([
        ...
        for i, (axis, p_top, p_crit, p_dang, label, esc) in enumerate([
            ...
            db.add(McpLlmAxisScore(
                id=f"ax-002-{i}",
                server_id="ana-002", axis_name=axis,
                label=label, p_top=p_top, p_critical=p_crit, p_danger=p_dang,
                escalated=esc,
                model_version="v1", scored_at=now,
            ))
        ...
        db.add(McpLlmAxisScore(
            id="ax-003-0",
            server_id="ana-003", axis_name="overall_risk",
